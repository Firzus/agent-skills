...
poles. This corpus is the engine-agnostic blueprint: the attack graph, hit
...
modes. Excluded (separate subjects): enemy AI (`enemy-ai-framework`), combat
...
movement HSM (`character-controller` reference) as the combat state's content.
