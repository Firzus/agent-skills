...
loot) regulatory compliance. The corpus spans four traditions and distinguishes
...
Excluded (separate subjects): deterministic pity/bad-luck *currency* economies
(`progression-economy`) and rolled item *stat generation* (substats live in
`inventory-equipment`). This corpus owns the *drop event*, not the item's stats.
