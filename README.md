...
| [`code-modernization`](./skills/code-modernization) | Guides modernization of legacy codebases with assessment, topology mapping, business-rule extraction, modernization briefs, behavior-preserving transformation, and hardening. |
