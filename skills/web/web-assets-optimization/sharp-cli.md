...
Video poster frames extracted as `{stem}-poster.jpg` (see [video.md](./video.md)) are ordinary rasters — optimize them with the same quality table.
...
- Animated GIF/WebP unless the task explicitly includes animation preservation — for GIF replacement and animated-format handling, follow [animated-media.md](./animated-media.md).
