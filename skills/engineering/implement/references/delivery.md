...
Use current tools/schemas and actual project states; do not invent labels or rename
the team's workflow. The implementer maintains evidence; the designated reviewer
accepts the result. One person may hold both roles.

| Transition | Required evidence |
| --- | --- |
| In progress | Work actually started |
| Review | Result and verification available to the reviewer |
| Blocked | Cause, resolution owner, required outcome, and next action |
| Done | All agreed acceptance and delivery conditions met |
...
2. Link the PR and check/review evidence in the existing issue. Record implemented,
   accepted, integrated, and deployed as separate facts. Never close merely because
   a PR exists or an automated status advanced.
...
If automation closes work before its acceptance conditions hold, report the mismatch
